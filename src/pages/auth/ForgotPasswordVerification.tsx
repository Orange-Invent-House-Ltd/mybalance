    ...
    <div className='md:flex justify-center flex-row-reverse'>
      ...
      <div className='md:w-[60%] lg:w-[70%]'>
        ...
        <div className='w-[365px] md::w-[376px] mt-16 mx-auto mb-10 md:mb-0 px-[5%]'>
          ...
          <p className='mt-2 mb-8 text-[#6D6D6D] text-center text-base leading-5 font-normal'>We sent a password reset link to <span className='font-bold'>{userEmail}</span></p>
          <a href="mailto:"><Button fullWidth>Open email app</Button></a>
          <p className='mt-6 text-sm font-normal w-fit mx-auto'>Didn’t receive the email? <span className='text-primary-normal cursor-pointer' onClick={()=>resendForgotPasswordLink()}>Click to resend</span></p>
        </div>
      </div>
    </div>
  )
