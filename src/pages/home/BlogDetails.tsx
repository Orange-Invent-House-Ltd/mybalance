  ...
  return (
    <div>
      ...
      <div className='mt-[9rem] flex flex-col justify-center items-center text-center lg:px-0 px-9'>
        <p className="mb-7 text-primary-blogCol font-bold">Published 20 Jan 2022</p>
        ...
        <div className="text-md font-light mb-11">
          <span className="lg:mr-5 mr-3 font-bold bg-col1bg text-col1 px-5 py-1 rounded-xl shadow-md">Design</span>
          <span className="lg:mr-5 mr-3 font-bold bg-col2bg text-col2  px-5 py-1 rounded-xl shadow-md">Research</span>
          <span  className=" font-bold bg-col3bg text-col3  px-5 py-1 rounded-xl shadow-lg">Presentation</span>
        </div>
      </div>
      <div className="w-full lg:px-24 md:px-8 px-3">
        <img src={detailimg} alt="" className="w-full lg:h-45 h-96"/>
      </div>
      
      <section className="lg:p-pad md:px-40 px-4 mt-12 mb-36">
        ...
        <div className="w-full object-cover mb-11">
          <img src={blogData.imgs} alt="" className="w-full lg:h-34 h-96 mb-4" />
        ...
        <div className="flex gap-8 mb-8">
          ...
          <div className="text-xl font-bold mt-3" >
            ...
            <p className="mt-10 text-base text-gray">— Olivia Rhye, Product Designer</p>
          </div>
        </div>
          ...
          <div>
            ...
            <ol className="text-gray list-decimal list-inside mt-2">
              <li> Lectus id duis
              vitae porttitor enim gravida morbi.</li>
              <li> Eu turpis posuere semper
              feugiat volutpat elit, ultrices suspendisse. Auctor vel in vitae
              placerat. </li>
              <li>Suspendisse maecenas ac donec scelerisque diam sed est
              duis purus.</li>
            </ol>
          </div>
