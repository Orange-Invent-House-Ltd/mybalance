...
const BlogDetails = () => {
  ...
  return (
    <div>
      ...
      <section className="lg:px-[25rem] md:px-36 px-4 mt-16 mb-36 ">
        <h1 className="mb-4 font-bold text-[25px] ">Introduction</h1>
        <p className="mb-9 text-slate-600 text-[19px] leading-8">
          {" "}
        ...
        <div className="flex gap-8 mb-8">
          ...
          {/* <div className="text-xl font-bold mt-3">
            ...
            <p className="mt-10 text-base text-gray">{blogData.author}</p>
          </div> */}
        </div>
        ...
        <div className="lg:flex block items-center justify-between">
          <div className="flex items-center space-x-4 user mt-8 mb-6">
            ...
            <div>
              ...
              <div className="text-gray-400 text-xs">{blogData.author}</div>
            </div>
          </div>
