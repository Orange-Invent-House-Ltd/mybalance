...
const QuickAction = () => {
  ...
  return (
    <div>
            ...
            <div className="px-4 py-5 flex-auto">
              <div className="tab-content tab-space">
                ...
                <div className={openTab === 3 ? "block" : "hidden"} id="link3">
                  {/* Unlock Money Tab ***************************************** */}
                  <p className="w-[449px] text-base font-normal">Click on the card with the information of the item you want to unlock and click on the unlock button. That’s it.</p>
                  <LockMoneyBox
                    lockicon= {lockicon}
                    date="Dec 15, 2022 4:56 PM"
                    heading="White Air Jordans"
                ...
                <div className={openTab === 4 ? "block" : "hidden"} id="link4">
                  {/* Withdraw Money Tab ***************************************** */}
                  <p className="w-[449px] text-base font-normal">In a case of a dispute with a seller, you can choose to withdraw your money into your bank account.</p>
      ...
      {/* Mobile footer */}
      <div className="pl-8 mb-16 md:hidden">
        <div className="flex gap-6 mb-2 ">
          <img src={twitter} alt="Twitter" />
          <img src={linkedin} alt="LinkedIn" />
          <img src={facebook} alt="Facebook" />
        </div>
        <p>© 2022 MyBalance. All rights reserved.</p>
      </div>
    </div>
  )
}
