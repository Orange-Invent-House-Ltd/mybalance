...
function BlogCardParent() {
  ...
  return (
    <div className=' transition-all duration-700 ease-in-out'>
      <div className={`mt-[-170px] md:mt-[-200px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-7 gap-x-8 md:px-14 h-${expanded ? 'auto' : 'h'} overflow-${overflow} hover:cursor-pointer`}>
