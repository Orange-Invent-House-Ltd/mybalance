...
const Header = () => {
  ...
  return (
    <div
      className={showMenu ? "bg-[#F7F7F7]  homeHeader " : "bg-white homeHeader"}
    >
      <div className="flex justify-center items-center gap-2">
        <Link to="/">
          <img src={logo} alt="logo" className="w-[39px]" />
        </Link>
      ...
      <div className="md:hidden text-right">
        ...
        <nav
          className={
            showMenu
              ? "homeNavMenu right-0 duration-300"
              : "homeNavMenu -right-full duration-700"
          }
        >
          <ul className="flex flex-col gap-5 text-[#373737] font-medium text-left">
            ...
            <li className="">
              ...
              <button
                ...
                className={display ? "w-full text-left" : ""}
              >
                Resources <ChevronDown className="inline" />
              </button>
              <div
                className={
                  display
                    ? "px-[5%] py-2 flex flex-col gap-3 items-start"
                    : "hidden absolute top-[70px] w-full z-10"
                }
              >
                <NavLink
                  to="/learn-mybalance"
                ...
                <NavLink to="/blog" className="text-[14px] font-medium">
                  Blog
                </NavLink>
              </div>
            </li>
            ...
            <li className="mb-4">
              <a
                href="https://documenter.getpostman.com/view/15948667/2sA3JFA4J3"
                target="_blank"
              >
                Developer Docs
              </a>
          ...
          <div className="" onClick={() => navigate("/buyer/register")}>
      ...
      <nav className="hidden md:flex">
        <ul className="flex items-center gap-6 text-[#373737] font-medium">
          ...
          <li>
            <NavLink to="/solutions" className="flex">
              Solutions{" "}
            </NavLink>
            <div
              className={
                display
                  ? "absolute top-[70px] left-0 w-full z-10 bg-white"
                  : "hidden absolute top-[70px] left-0 w-full z-10 bg-white"
              }
            >
              <div className="flex justify-evenly items-center gap-10 h-[142px] px-[5%]">
                <div>
                  <NavLink to="#" className="text-[23px] font-bold">
                    Buyers & Vendors
                  </NavLink>
                  <p className="text-sm font-regular text-[#6D6D6D]">
                    For small scale vendors and individual buyers
                  </p>
                </div>
                <div>
                  <NavLink to="#" className="text-[23px] font-bold">
                  ...
                  <p className="text-sm font-regular text-[#6D6D6D]">
                    For organizations and their merchants
                  </p>
                </div>
                <div>
                  <NavLink to="#" className="text-[23px] font-bold">
                  ...
                  <p className="text-sm font-regular text-[#6D6D6D]">
                    For government parastatals and contractors
                  </p>
                </div>
              </div>
            ...
            <div className="hidden absolute right-[-80px] rounded-[8px] w-[296px] bg-white py-4 mt-[3px] z-10">
              <div className="h-[142px] px-[5%]">
                <div>
                  <NavLink
                    to="/learn-mybalance"
                    className="text-[18px] text-[#101828] font-semibold"
                  >
                    Learn Mybalance
                  </NavLink>
                  <p className="text-sm font-regular text-[#6D6D6D] mb-4">
                    Discover MyBalance with Our Easy Video Tutorials!
                  </p>
                </div>
                <div>
                  <NavLink
                  ...
                  <p className="text-sm font-regular text-[#6D6D6D]">
                    Find out the latest MyBalance news
                  </p>
                </div>
              </div>
            </div>
