...
const BuyerDashboardLayout = () => {
  ...
  return (
    <div>
      ...
      <div className="md:hidden bg-white sticky top-0 left-0 z-50 py-2 px-5 flex justify-between items-center mb-10">
        ...
        <div className="hidden md:block w-[350px] text-white sticky top-0 left-0 h-screen bg-[#3A3A3A] ">
          ...
          <nav>
            <ul className="flex flex-col gap-2">
              <li className="hover:bg-white focus:bg-white hover:text-black">
                <Link
                  to="/buyer/dashboard"
