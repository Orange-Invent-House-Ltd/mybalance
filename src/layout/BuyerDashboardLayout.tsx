  ...
  return (
    <div>
      ...
      <div className="md:flex">
        {/* mobile navbar */}
        <div className="md:hidden bg-white sticky top-0 left-0 z-10 py-[5%] px-5 flex justify-between items-center mb-5 md:mb-10">
        ...
        {/* desktop navbar */}
        <div className="hidden h-screen overflow-y-scroll no-scrollbar md:block min-w-[207px] text-white sticky top-0 left-0 bg-[#3A3A3A] pb-8">
