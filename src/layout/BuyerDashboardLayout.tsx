      ...
      <div className="w-[250px] text-white sticky top-0 left-0 h-screen bg-[#3A3A3A] ">
        ...
        <nav>
          <ul className="flex flex-col gap-2">
            ...
            <li className="hover:bg-white focus:bg-white hover:text-black"><a href="/buyer/" className="flex items-center gap-4 pl-4 py-2"><svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none">
              <g stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" clip-path="url(#a)">
            ...
            <li className="hover:bg-white focus:bg-white hover:text-black"><a href="/buyer/" className="flex items-center gap-4 pl-4 py-2"><svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg"  fill="none">
                <path  stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M11.291 14.826c0 .577-.228 1.13-.634 1.537a2.164 2.164 0 0 1-3.699-1.537M1 12.652h16.25M16.166 12.652h.542c-1.197 0-2.708-.973-2.708-2.174V5.587a4.9 4.9 0 0 0-1.428-3.459 4.867 4.867 0 0 0-6.894 0A4.9 4.9 0 0 0 4.25 5.587v4.891c0 .577-.229 1.13-.635 1.537a2.163 2.163 0 0 1-1.532.637"/>
              </svg> Notifications</a>
            </li>
            ...
            <li className= "hover:bg-white focus:bg-white hover:text-black"><NavLink  to="/buyer/settings" className="flex items-center gap-4 pl-4 py-2"><svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none">
              <g stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" clip-path="url(#a)">
              ...
              </svg> Settings</NavLink>
            </li>
          </ul>
          <div className="mt-[20px] pl-4 text-[#DA1E28] hover:bg-white focus:bg-white"><a href="" className="flex gap-4 py-2"><svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none"><g stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" clip-path="url(#a)">
